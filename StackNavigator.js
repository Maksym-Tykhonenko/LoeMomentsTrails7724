...
import MomenstLoadingPage from './lomensrcm/lyfrenscrens/MomenstLoadingPage';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import OnboardingScreen from './lomensrcm/lyfrenscrens/MosOnboardingScn';
import { LemontsWrapAppLocalize } from './lomensrcm/LemontsWrapAppLocalize';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
//
import ProductScreen from './lomensrcm/ProductScreen';
import {
  ActivityIndicator,
  View,
  StyleSheet,
...
import { CLOAKA, SCREENS, TIMINGS } from './lomensrcm/config/projectConfig';
...
const RootNavigator = () => {
  ...
  return (
    <NavigationContainer ref={navigationRef} onReady={() => setNavReady(true)}>
      <Stack.Navigator
        //initialRouteName="MomenstLoadingPage"
        screenOptions={{
      ...
      >
        ...
        />
        <Stack.Screen
          name="MosOnboardingScn"
          component={OnboardingScreen}
          options={{ headerShown: false, animation: 'fade' }}
        />
        <Stack.Screen
          name="MainApp"
          component={LemontsWrapAppLocalize}
          options={{
            headerShown: false,
            animation: 'fade',
